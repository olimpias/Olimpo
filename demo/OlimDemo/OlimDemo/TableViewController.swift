...
class TableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        Olimpo.load(urlArray[index]).placeHolder(UIImage(named: "load")!).error(UIImage(named: "error")!).reSize(50, width: 50).contentMode(UIViewContentMode.Center).into(cell.sectionImageView);
